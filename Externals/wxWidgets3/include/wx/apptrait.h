...
// ABX: check __WIN32__ instead of __WXMSW__ for the same MSWBase in any Win32 port
    ...
    #include "wxWidgets3/include/wx/msw/apptbase.h"
#elif defined(__UNIX__)
    #include "wxWidgets3/include/wx/unix/apptbase.h"
...
// ABX: check __WIN32__ instead of __WXMSW__ for the same MSWBase in any Win32 port
#if defined(__WIN32__)
    #include "wxWidgets3/include/wx/msw/apptrait.h"
#elif defined(__UNIX__)
    #include "wxWidgets3/include/wx/unix/apptrait.h"
#else
    #if wxUSE_GUI
