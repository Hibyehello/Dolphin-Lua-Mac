...
#pragma pack(pop)
    ...
    static u64 s_currentFrame, s_totalFrames;
    static u64 s_currentLagCount;
    static u64 s_currentInputCount, s_totalInputCount;
    ...
    // methods from vanilla Dolphin 5.0-7002 - ThatsSlick
